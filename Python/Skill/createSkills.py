...
# List of skills to be created
skills = [
"Skill1", "Skill2", "Skill3" 
]

# Loop through the skills and create each one
for skill in skills:
    # Define the SOAP envelope with the createSkill request for each skill
    soap_envelope = f"""
   ...
   <soapenv:Body>
    ...
    if response.status_code == 200:
        ...
        if success_element is not None and success_element.text == "true":
            print(f"Skill '{skill}' has been successfully created.")
        else:
